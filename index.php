...
$article = new Article('This is an article title!', 'This is a text of an article.', false);
...
$article2 = new Article('This is another article title with breaking news!', 'This is another text of another article with breaking news.', true);
